...
if(isset($_POST["submit"])) {
    ...
    if ($uploadOk != 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $fileID = $database->ajouterDevoir(basename($_FILES["fileToUpload"]["name"]), $dir);

            $database->ajouterDevoirBD($titre, $description, $module, $annee, $professeurID, $fileID);
